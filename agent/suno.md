...
The style prompt ought focus upon the audible features of the song, and **SHOULD NOT** dive *too* deeply in into the narrative elements of the story – a bit is fine and good, but it's easy to go too far with it. Suno limits the style prompts to under 1000 characters, so you **MUST** be sure to stay under this limit. 
