...
The $1 branch was recently updated with the latest changes from upstream/dev, so it's possible that that  branch was damaged during its last commit when these changes were merged into it. 
