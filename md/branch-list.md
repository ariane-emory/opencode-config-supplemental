...
- feat/improve-bash-tool-git-advice (PR#215, **MERGE ADVICE**: Make sure to combine this properly with the changes to the shelll tool's description that are made in the feat/shell-advice branch, both sets of changes must be synthesized!)
- feat/shell-tool-unblacklist-fish-and-extend-dynamic-naming (PR#278, **MERGE ADVICE**: Make sure to combine this properly with the changes to the shell tool's description that are made in the feat/improve-bash-tool-git-advice branch, both sets of changes must be synthesized! **NO** shells must be blacklisted!)
