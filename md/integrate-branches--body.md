You **MUST** set the title of the current session to "Integrations:|" followed by the name of the integration branch (for example "Integrations:|integraton/1970-01-01-12-34") and bookmark it.
