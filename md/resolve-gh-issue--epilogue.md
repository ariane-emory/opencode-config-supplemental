...
Group the plan's steps into "phases". After completing each phase, the code **MUST** build correctly and all tests (except for any pre-evisting errors that already existed on the the ${2:dev} branch and any enterprise tests, you can ignore those) **MUST** pass. 
