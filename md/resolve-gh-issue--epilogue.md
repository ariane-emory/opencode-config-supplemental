...
You **SHOULD** use the `set_current_session_title` tool to give the session a name consisting of the string "Issu:|" followed by the name of the new branch followed by the title of the issue.
