...
You **SHOULD** use the `set_current_session_title` tool to give the session a name consisting of the name of the new branch followed by the title of the issue and **SHOULD** also use the `bookmark_current_session` tool to bookmark it.
