...
const semaphorePresentSound = [normalize(resolve(configPath, "audio", "riff.aiff")), 0.35,];
const noSemaphorePresentSound = [normalize(resolve(configPath, "audio", "riff2.aiff")), 0.35,];
const permissionPromptSound = [normalize(resolve(configPath, "audio", "riff3.aiff")), 0.35,];
