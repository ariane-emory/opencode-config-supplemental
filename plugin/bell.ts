...
const semaphorePresentSound = [normalize(resolve(configPath, "audio", "riff.aiff")), 0.2,];
const noSemaphorePresentSound = [normalize(resolve(configPath, "audio", "riff2.aiff")), 0.2,];
